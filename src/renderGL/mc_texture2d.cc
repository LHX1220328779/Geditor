...
bool Texture2D::Create(const Image &image) {
  ...
  if (handle_ > 0) {
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, glinternalFormat, width_, height_, 0,
...
void Texture2D::MappingFormat(int &internalFormat, int &glformat, int &gltype,
