...
RenderStateObject::RenderStateObject(const RasterizerStateDesc &rs_desc,
...
BlendStateDesc RenderStateObject::GetBlendStateDesc() const { return bs_desc_; }
...
void RenderStateObject::ActiveRenderState() {
  ...
  glBlendFuncSeparate(bs_desc_.src_blend, bs_desc_.dest_blend,
                      bs_desc_.src_blend_alpha, bs_desc_.dest_blend_alpha);
...
SamplerStateDesc SamplerStateObject::GetDesc() const { return desc_; }
