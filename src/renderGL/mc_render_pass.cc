...
RenderPass::RenderPass() : render_state_obj_(NULL), shader_program_(NULL) {}
...
void RenderPass::SetShaderProgram(Program *shader) { shader_program_ = shader; }

Program *RenderPass::GetShaderProgram() const { return shader_program_; }
