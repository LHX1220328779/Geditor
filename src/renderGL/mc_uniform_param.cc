...
UniformParam::UniformParam() : element_num_(0), buffer_(NULL), length_(0) {}
...
void UniformParam::UniformElement(unsigned int location, UNIFORM_TYPE type,
                                  int count) {
...
unsigned int UniformParam::GetUniformNumber() const { return element_num_; }
