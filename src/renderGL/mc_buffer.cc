...
Buffer::Buffer(int numElements, int elementSize, Usage usage)
    : num_elements_(numElements),
      ...
      usage_(usage),
      num_bytes_(numElements * elementSize) {
...
int Buffer::GetNumElements() const { return num_elements_; }

int Buffer::GetElementSize() const { return element_size_; }

Buffer::Usage Buffer::GetUsage() const { return usage_; }

int Buffer::GetNumBytes() const { return num_bytes_; }

char *Buffer::GetData() const { return pdata_; }
...
void IndexBuffer::SetOffset(int offset) { offset_ = offset; }

int IndexBuffer::GetOffset() const { return offset_; }
