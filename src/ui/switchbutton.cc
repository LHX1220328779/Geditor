...
switchbutton::switchbutton(QWidget *parent) : QWidget(parent) {
  ...
  m_bgColorOn = QColor(0, 0, 255);  //设置按钮内部颜色
...
int switchbutton::space() const { return m_space; }

int switchbutton::radius() const { return m_radius; }

bool switchbutton::checked() const { return m_checked; }

bool switchbutton::showText() const { return m_showText; }

bool switchbutton::showCircel() const { return m_showCircle; }

bool switchbutton::animation() const { return m_animation; }

QColor switchbutton::bgColorOn() const { return m_bgColorOn; }

QColor switchbutton::bgColorOff() const { return m_bgColorOff; }

QColor switchbutton::sliderColorOn() const { return m_sliderColorOn; }

QColor switchbutton::sliderColorOff() const { return m_sliderColorOff; }

QColor switchbutton::textColor() const { return m_textColor; }

QString switchbutton::textOn() const { return m_textOn; }

QString switchbutton::textOff() const { return m_textOff; }

int switchbutton::step() const { return m_step; }

int switchbutton::startX() const { return m_startX; }

int switchbutton::endX() const { return m_endX; }
