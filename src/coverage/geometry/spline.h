#ifndef __TOOLBOX_GEOMETRY_CURVES_SPLINE_H__
#define __TOOLBOX_GEOMETRY_CURVES_SPLINE_H__
...
class Spline {
 ...
 public:
  void GetPath(SiteVec &list, SiteVec &anchors, double density = 0.05);
...
#endif  // __TOOLBOX_GEOMETRY_CURVES_SPLINE_H__