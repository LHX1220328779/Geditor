...
typedef std::vector<PointInfo> Polygon;
//
...
class ReedsSheppStateSpace {
 public:
  ...
  void GetPath(SiteVec &list, Site start, Site end, double density = 0.05);
  /************************/

 protected:
  void interpolate(double q0[3], ReedsSheppPath &path, double seg, double q[3]);
  void interpolate_1(double q0[3], ReedsSheppPath path, double seg,
                     double s[4]);
