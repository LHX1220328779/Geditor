...
#include "pathplanner/delaunay/edge.h"
#include "pathplanner/delaunay/triangle.h"
#include "pathplanner/delaunay/vector2.h"
    ...
    for (auto p = begin(vertices); p != end(vertices); p++) {
      ...
      for (auto& t : _triangles) {
        ...
        if (t.circumCircleContains(*p)) {
          ...
          // std::cout << " does not contains " << *p << " in his circum center"
          // << std::endl;
        }
      }
