...
template <>
struct nth<0, geditor::V2f> {
  inline static float get(const geditor::V2f &v) { return v.x; }
};

template <>
struct nth<1, geditor::V2f> {
  inline static float get(const geditor::V2f &v) { return v.y; }
};
